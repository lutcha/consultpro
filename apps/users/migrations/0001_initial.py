    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv_document', models.FileField(blank=True, null=True, upload_to='consultants/cv/')),
                ...
                ('performance_rating', models.DecimalField(decimal_places=2, default=0, help_text='Rating from 0.00 to 5.00', max_digits=3)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
