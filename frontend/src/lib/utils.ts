...
export function getStatusColor(status: string): string {
  const statusColors: Record<string, string> = {
    ...
    ready_for_submission: 'bg-emerald-100 text-emerald-800 border-emerald-200',
    approved: 'bg-green-100 text-green-800 border-green-200',
    submitted: 'bg-blue-100 text-blue-800 border-blue-200',
    under_evaluation: 'bg-indigo-100 text-indigo-800 border-indigo-200',
    rejected: 'bg-red-100 text-red-800 border-red-200',
    shortlisted: 'bg-cyan-100 text-cyan-800 border-cyan-200',
    clarifications_requested: 'bg-amber-100 text-amber-800 border-amber-200',
    bafo: 'bg-purple-100 text-purple-800 border-purple-200',
    awarded: 'bg-green-100 text-green-800 border-green-200',
    contract_negotiation: 'bg-yellow-100 text-yellow-800 border-yellow-200',
    contract_signed: 'bg-emerald-100 text-emerald-800 border-emerald-200',
    project_initiation: 'bg-blue-100 text-blue-800 border-blue-200',
