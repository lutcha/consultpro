...
export function mapApiOpportunity(opp: ApiOpportunity): Opportunity {
  return {
    ...
    consortiumType: (opp.consortium_type || 'solo') as Opportunity['consortiumType'],
    consortiumNotes: opp.consortium_notes || undefined,
    partnerProfiles: opp.partner_profiles || [],
